...
from ndarray import wfpkfinder_cfd # from psana2.pycalgos
from psana2.hexanode.WFUtils import peak_finder_v2, peak_finder_v3
from psana2.hexanode.PyCFD import PyCFD
