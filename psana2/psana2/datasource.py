...
from psana2.psexp.serial_ds import SerialDataSource
from psana2.psexp.singlefile_ds import SingleFileDataSource
from psana2.psexp.shmem_ds import ShmemDataSource
from psana2.psexp.drp_ds import DrpDataSource
from psana2.psexp.legion_ds import LegionDataSource
from psana2.psexp.null_ds import NullDataSource
    ...
    # ==== from experiment directory ====
        ...
        if mode == "mpi":
            if world_size == 1:
                ...
                #    as much as possible.
                from psana2.psexp.node import Communicators
                from psana2.psexp.mpi_ds import MPIDataSource
