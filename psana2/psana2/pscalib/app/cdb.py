...
from psana2.pyalgos.generic.logger import config_logger, STR_LEVEL_NAMES
SCRNAME = sys.argv[0].rsplit('/')[-1]

import psana2.pscalib.calib.CalibConstants as cc
from psana2.pscalib.calib.MDBWeb_CLI import cdb_web, MODES  #  cdb  # includes import from MDB_CLI
