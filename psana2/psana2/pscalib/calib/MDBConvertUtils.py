...
"""
    Usage ::
    from psana2.pscalib.calib.MDBConvertUtils import numpy_scalar_types, compare_dicts, is_none,\
...
if __name__ == "__main__":
  ...
  from psana2.pyalgos.generic.NDArrGenerators import aranged_array, random_standard
