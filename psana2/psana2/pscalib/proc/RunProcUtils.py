...
from psana2.pyalgos.generic.PSUtils import list_of_runs_in_xtc_dir #, list_of_files_in_dir_for_ext 
from psana2.pyalgos.generic.PSConstants import INSTRUMENTS, DIR_INS, DIR_LOGS

#------------------------------

DIR_LOG = '%s/run_proc' % DIR_LOGS
