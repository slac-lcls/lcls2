...
Usage::
    ...
    from psana2.pscalib.geometry.SegGeometryJungfrauV2 import jungfrau_one as sg
...
from psana2.pscalib.geometry.SegGeometryJungfrauV1 import * # SegGeometryJungfrauV1, logging, np
