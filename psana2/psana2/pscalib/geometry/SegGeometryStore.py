...
def segment_geometry(**kwa):
    ...
    if segname=='EPIX10KA:V1':
        from psana2.pscalib.geometry.SegGeometryEpix10kaV1 import epix10ka_one, epix10ka_wpc
        return epix10ka_wpc if wpc else epix10ka_one
    elif segname=='EPIXHR2X2:V1':
        from psana2.pscalib.geometry.SegGeometryEpixHR2x2V1 import epixhr2x2_one, epixhr2x2_wpc
        return epixhr2x2_wpc if wpc else epixhr2x2_one
    elif segname=='EPIXHR1X4:V1':
        from psana2.pscalib.geometry.SegGeometryEpixHR1x4V1 import epixhr1x4_one, epixhr1x4_wpc
...
#        from psana2.pscalib.geometry.SegGeometryEpixM320V1 import epixm320_one
#        return epixm320_one
    elif segname=='EPIXMASIC:V1': # The same as 'MTRX:V2:192:384:50:50' # EPIXM ASIC
        from psana2.pscalib.geometry.SegGeometryMatrixV2 import SegGeometryMatrixV2, matrix_pars_v2
        ...
        from psana2.pscalib.geometry.SegGeometryMatrixAnyV1 import SegGeometryMatrixAnyV1
        sg = SegGeometryMatrixAnyV1()
        #sg.init_matrix_parameters(shape=(512,1024), pix_size_rcsd_um=(75,75,75,400))
        return sg
    elif segname[:4]=='MTRX':
        from psana2.pscalib.geometry.SegGeometryMatrixV1 import SegGeometryMatrixV1, matrix_pars, segment_one
        ...
        from psana2.pscalib.geometry.SegGeometryJungfrauV1 import jungfrau_one
        return jungfrau_one
    elif segname=='JUNGFRAU:V2':
        from psana2.pscalib.geometry.SegGeometryJungfrauV2 import jungfrau_front
        return jungfrau_front
    elif segname=='PNCCD:V1':
        from psana2.pscalib.geometry.SegGeometryMatrixV1 import segment_one
        return segment_one
    elif segname=='EPIX100:V1':
        from psana2.pscalib.geometry.SegGeometryEpix100V1 import epix2x2_one, epix2x2_wpc
        return epix2x2_wpc if wpc else epix2x2_one
    elif segname=='SENS2X1:V1':
        from psana2.pscalib.geometry.SegGeometryCspad2x1V1 import cspad2x1_one, cspad2x1_wpc
        return cspad2x1_wpc if wpc else cspad2x1_one
    elif segname=='ARCHON:V1':
        from psana2.pscalib.geometry.SegGeometryArchonV1 import SegGeometryArchonV1
        return SegGeometryArchonV1(detector=kwa.get('detector', None),
                                   shape=kwa.get('shape', None))
    elif segname=='ARCHON:V2':
        from psana2.pscalib.geometry.SegGeometryArchonV2 import SegGeometryArchonV2
