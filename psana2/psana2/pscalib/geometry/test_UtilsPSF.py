...
if __name__ == "__main__":
  ...
  from psana2.pscalib.geometry.UtilsPSF import *
  from psana2.pscalib.geometry.GeometryAccess import img_from_pixel_arrays, GeometryAccess
  ...
  def test_psana_image(geo, data):
    ...
    from psana2.detector.UtilsGraphics import gr, fleximagespec, fleximage, flexhist #, axis_plot
