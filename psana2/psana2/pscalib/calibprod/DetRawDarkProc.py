...
from psana2.pyalgos.generic.NDArrUtils import print_ndarr, info_ndarr, divide_protected
from psana2.pyalgos.generic.Utils import do_print
from psana import DataSource
from psana2.pscalib.calib.NDArrIO import save_txt
from psana2.pscalib.calib.CalibConstants import TSFORMAT
...
class DetRawDarkProc:
    ...
    def summary(self, evt):
        ...
        if self.addcdb:
            from psana2.pscalib.calib.MDBCommands import add_constants
