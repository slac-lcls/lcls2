...
def test_import_geoseg_cspad2x1() :
    ...
    from psana2.pscalib.geonew.geoseg_cspad2x1 import seg_cspad2x1
    from psana2.pscalib.geonew.geoseg_base import AXIS_X, AXIS_Y, AXIS_Z
...
def test_load_geoseg_cspad2x1() :
    ...
    from psana2.pscalib.geonew.utils import object_from_python_code
