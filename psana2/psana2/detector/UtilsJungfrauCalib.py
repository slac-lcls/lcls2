...
Usage::
    from psana2.detector.UtilsJungfrauCalib import *
...
import psana2.detector.dir_root as dr
import psana2.detector.UtilsCalib as uc
from psana2.detector.RepoManager import init_repoman_and_logger, fname_prefix, fname_prefix_merge
import psana2.detector.utils_psana as ups # seconds, data_source_kwargs#
from psana2.detector.NDArrUtils import info_ndarr, save_2darray_in_textfile, save_ndarray_in_textfile # import divide_protected
import psana2.detector.Utils as uts # info_dict
import psana2.pscalib.calib.CalibConstants as cc
from psana2.detector.UtilsCalibRepo import save_constants_in_repository
