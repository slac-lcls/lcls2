...
Usage::
    from psana2.detector.UtilsEpix10ka import ...
...
from psana2.detector.NDArrUtils import info_ndarr, divide_protected
from psana2.detector.UtilsMask import merge_masks, DTYPE_MASK
from psana2.detector.UtilsCommonMode import common_mode_cols,\
