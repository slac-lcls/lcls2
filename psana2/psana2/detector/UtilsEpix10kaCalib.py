...
from psana2.detector.UtilsLogging import logging  # DICT_NAME_TO_LEVEL, STR_LEVEL_NAMES
...
from psana2.detector.UtilsEpix import FNAME_PANEL_ID_ALIASES, alias_for_id
from psana2.detector.Utils import log_rec_at_start, str_tstamp, create_directory, save_textfile, set_file_access_mode, time_sec_from_stamp, get_login, info_dict
...
from psana2.detector.utils_psana import seconds, data_source_kwargs, dict_filter
from psana2.detector.UtilsLogging import init_file_handler
...
def deploy_constants(parser):
    ...
    from psana2.pscalib.calib.NDArrIO import save_txt; global save_txt
