...
Usage::
  ...
  from psana2.detector.epix_base import epix_base
...
from psana2.detector.areadetector import sgs, AreaDetectorRaw, np, ut, DTYPE_MASK, DTYPE_STATUS, au
from psana2.detector.UtilsEpix10ka import calib_epix10ka_any, map_gain_range_index,\
  cbits_config_epix10ka, cbits_config_epixhr2x2, cbits_config_epixhr1x4,\
  cbits_config_and_data_detector, M14, M15, B14, B15
import psana2.detector.UtilsMask as um #import merge_status
