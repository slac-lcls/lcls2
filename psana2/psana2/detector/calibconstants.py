...
from psana2.detector.NDArrUtils import info_ndarr, divide_protected, reshape_to_3d  # print_ndarr,shape_as_2d, shape_as_3d, reshape_to_2d
from psana2.pscalib.geometry.GeometryAccess import GeometryAccess  # img_from_pixel_arrays

from psana2.detector.UtilsAreaDetector import dict_from_arr3d, arr3d_from_dict,\
...
from psana2.detector.UtilsMask import DTYPE_MASK, DTYPE_STATUS
...
class CalibConstants:
    def __init__(self, calibconst, **kwa):
        ...
        Parameters
        ----------
        calibconst: dict - retrieved from DB by method calib_constants_all_types from psana2.pscalib.calib.MDBWebUtils.
        **kwa: not used
        """
