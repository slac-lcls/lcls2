...
Usage::
import psana2.detector.UtilsCalibRepo as ucr
...
import psana2.detector.Utils as uts
import psana2.detector.UtilsCalib as uc
import psana2.detector.utils_psana as ups
import psana2.pscalib.calib.CalibConstants as cc
from psana2.detector.NDArrUtils import info_ndarr, save_2darray_in_textfile, save_ndarray_in_textfile
from psana2.detector.RepoManager import set_repoman_and_logger, fname_prefix, calib_file_name
...
def _check_gainmode(**kwa):
    ...
    dettype  = kwa.get('dettype', None)
    if dettype == 'jungfrau':
        from psana2.detector.UtilsJungfrauCalib import DIC_GAIN_MODE
        ...
        from psana2.detector.UtilsEpix10ka import GAIN_MODES_IN
...
def _check_ctype(kwa):
    from psana2.pscalib.calib.CalibConstants import list_calib_names
