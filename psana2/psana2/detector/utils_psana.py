...
Usage::
    ...
    from psana2.detector.utils_psana import seconds, timestamp_run, datasource_kwargs, info_run
...
from psana2.detector.Utils import info_dict, str_tstamp #, info_namespace, info_command_line
...
def datasource_kwargs_from_string(s, detname=None):
    ...
    """
    import psana2.psexp.utils as ut
