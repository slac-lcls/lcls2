...
Usage::
    ...
    from psana2.detector.UtilsCalib import *
    #OR
...
from psana2.detector.Utils import str_tstamp, time, get_login, info_dict  # info_command_line
import psana2.pscalib.calib.CalibConstants as cc
from psana2.detector.NDArrUtils import info_ndarr, divide_protected, reshape_to_2d, save_ndarray_in_textfile
from psana2.detector.RepoManager import init_repoman_and_logger, set_repoman_and_logger, fname_prefix
...
def detector_name_short(detlong, maxsize=cc.MAX_DETNAME_SIZE, add_shortname=True):
  ...
  """
  from psana2.pscalib.calib.MDBWebUtils import pro_detector_name
...
def deploy_constants(dic_consts, **kwa):
    ...
    from psana2.pscalib.calib.MDBUtils import data_from_file
    from psana2.pscalib.calib.MDBWebUtils import add_data_and_two_docs
