...
Usage::
  ...
  from psana2.detector.areadetector import AreaDetector, AreaDetectorRaw
...
from psana2.pscalib.geometry.SegGeometryStore import sgs  # used in epix_base.py and derived
from psana2.pscalib.geometry.GeometryAccess import GeometryAccess
import psana2.detector.NDArrUtils as au # reshape_to_3d, shape_as_3d, shape_as_3d, reshape_to_2d
...
import psana2.detector.Utils as ut
