...
import sys
#import getpass
import psana2.detector.Utils as ut  #OR: import psana.pyalgos.generic.Utils as ut

from psana2.detector.dir_root import DIR_REPO, DIR_LOG_AT_START  # DIR_ROOT + '/detector/logs/atstart
...
def init_repoman_and_logger(**kwa):
    from psana2.detector.UtilsLogging import init_logger, init_stream_handler, init_file_handler
