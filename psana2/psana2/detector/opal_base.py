...
Usage::
  ...
  from psana2.detector.opal_base import opal_base
...
from psana2.detector.areadetector import AreaDetector, np
from psana2.detector.UtilsAreaDetector import arr3d_from_dict
from psana2.detector.NDArrUtils import reshape_to_2d, divide_protected, info_ndarr
