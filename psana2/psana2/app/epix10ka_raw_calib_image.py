...
from psana2.pyalgos.generic.NDArrUtils import info_ndarr, divide_protected
from psana2 import DataSource
from psana2.detector.UtilsMask import CC, DTYPE_MASK
from psana2.detector.utils_psana import datasource_kwargs_from_string, timestamp_run
...
def ds_run_det(args):
    ...
    from psana2.pyalgos.generic.Utils import str_attributes
...
import psana2.detector.UtilsEpix10ka as ue
    from psana2.detector.UtilsGraphics import gr, fleximage, flexhist, fleximagespec
