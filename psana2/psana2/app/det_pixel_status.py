...
import sys
from psana2.detector.dir_root import DIR_REPO as DIR_REPO_STATUS
from psana2.detector.UtilsLogging import STR_LEVEL_NAMES  #logging
...
def do_main():
    ...
    from psana2.detector.UtilsPixelStatus import det_pixel_status
