...
from psana2.detector.UtilsLogging import sys, logging, DICT_NAME_TO_LEVEL, init_stream_handler, init_file_handler
...
def run_parser_do_main():
    ...
    #from psana2.detector.Utils import save_log_record_at_start
...
import psana2.detector.RepoManager as rm
    ...
    from psana2.detector.utils_roicon import do_main
