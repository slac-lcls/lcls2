...
from psana2.graphqt.CMWControlBase import * # CMWControlBase, QApplication, ..., icon, style, cp, logging, os, sys
...
import psana2.graphqt.UtilsSubproc as usp
    ...
    def on_but_exp(self):
        ...
        from psana2.graphqt.CMConfigParameters import dir_calib
