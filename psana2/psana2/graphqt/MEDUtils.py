...
Usage ::
    ...
    from psana2.graphqt.MEDUtils import *
...
from psana2.pyalgos.generic.NDArrUtils import reshape_to_2d, reshape_to_3d, info_ndarr, np
import psana2.pscalib.calib.MDBWebUtils as mdbwu
from psana2.detector.dir_root import DIR_FFB, DIR_DATA, DIR_DATA_TEST #, DIR_FFB='/sdf/data/lcls/drpsrcf/ffb' or DIR_DATA='/sdf/data/lcls/ds/'
import psana2.detector.Utils as ut  # info_dict, info_command_line, info_namespace, info_parser_arguments, str_tstamp
...
def mask_ndarray_from_2d(mask2d, geo):
    from psana2.pscalib.geometry.GeometryAccess import GeometryAccess, convert_mask2d_to_ndarray # GeometryAccess, img_from_pixel_arrays
...
def ds_run_from_str_dskwargs(dskwargs='exp=uedcom103,run=812'):
    from psana2 import DataSource # dt(sec)=0.000004
    from psana2.detector.utils_psana import datasource_kwargs_from_string # dt(sec)=0.000612
...
def datasource_kwargs_from_string(s):
    from psana2.psexp.utils import datasource_kwargs_from_string
    return datasource_kwargs_from_string(s)

def datasource_kwargs_to_string(**kwargs):
    from psana2.psexp.utils import datasource_kwargs_to_string
