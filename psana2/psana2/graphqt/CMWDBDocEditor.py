...
Usage ::
    ...
    # Import
    from psana2.graphqt.CMWDBDocEditor import *
...
from psana2.graphqt.CMDBUtils import dbu #ObjectId, get_data_for_doc, doc_add_id_ts, time_and_timestamp #, timestamp_id

from psana2.graphqt.QWUtils import get_open_fname_through_dialog_box
