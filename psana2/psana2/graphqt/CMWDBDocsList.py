...
Usage ::
    # Import
    from psana2.graphqt.CMWDBDocsList import *
...
"""
from psana2.graphqt.CMWDBDocsBase import * # CMWDBDocsBase, dbu, logger
from psana2.graphqt.QWList import QWList, QStandardItem, icon
...
class CMWDBDocsList(CMWDBDocsBase, QWList):
    ...
    def fill_list_model(self, docs=None, recs=None):
