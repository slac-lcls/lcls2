...
Usage ::
    ...
    from psana2.graphqt.GWSpectrum import GWSpectrum
    w = GWSpectrum()
...
from psana2.graphqt.GWViewHist import * # GWViewHist # , test_histogram
from psana2.graphqt.GWViewAxis import GWViewAxis
from psana2.graphqt.GWViewColorBar import GWViewColorBar
import psana2.graphqt.ColorTable as ct
from PyQt5.QtWidgets import QWidget, QGridLayout, QPushButton, QTextEdit
from PyQt5.QtCore import Qt, pyqtSignal, QRectF
from psana2.pyalgos.generic.NDArrGenerators import np, test_image, random_standard
