...
Usage ::
    from psana2.graphqt.CMConfigParameters import cp, dir_calib
...
from psana2.pyalgos.generic.Utils import list_of_hosts as lshosts
import psana2.pscalib.calib.CalibConstants as cc
import psana2.pyalgos.generic.PSUtils as psu # dir_calib, dir_exp
from psana2.detector.dir_root import DIR_ROOT
