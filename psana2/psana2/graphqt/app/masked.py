...
import sys
import psana2.graphqt.MEDUtils as mu  # includes psana.detector.Utils info_dict, info_command_line, info_namespace, info_parser_arguments, str_tstamp
...
import psana2.graphqt.MEDMain as mm
