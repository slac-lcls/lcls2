...
Usage ::
    ...
    from psana2.graphqt.IVControl import IVControl
    w = IVControl()

Created on 2021-06-14 by Mikhail Dubrovin
"""

from psana2.graphqt.CMWControlBase import * #cp, CMWControlBase, QApplication, os, sys, logging, QRectF, QWFileNameV2
from psana2.graphqt.IVControlSpec import IVControlSpec
import psana2.pyalgos.generic.PSUtils as psu
from psana2.pyalgos.generic.NDArrUtils import reshape_to_2d, info_ndarr, np
...
class IVControl(CMWControlBase):
    ...
    def on_buts(self):
        ...
        from psana2.graphqt.QWUtils import change_check_box_dict_in_popup_menu
        d = self.buttons_dict()
