...
from psana2.graphqt.GWViewExt import * # GWViewExt, QtGui, QtCore, Qt
from psana2.graphqt.GWHist import GWHist, test_histogram
from PyQt5.QtGui import QColor, QFont

from psana2.pyalgos.generic.HBins import HBins, np
