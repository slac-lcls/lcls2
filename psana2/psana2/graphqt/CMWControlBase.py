...
Usage ::
    ...
    from psana2.graphqt.CMWControlBase import CMWControlBase
    w = CMWControlBase()
...
from psana2.graphqt.QWFileNameV2 import QWFileNameV2
from psana2.graphqt.CMConfigParameters import cp, dirs_to_search, expname_def, dir_calib
from psana2.graphqt.Styles import style
from psana2.graphqt.QWIcons import icon
import psana2.graphqt.QWUtils as qwu
...
COMMAND_SET_ENV_LCLS1 = '. /sdf/group/lcls/ds/ana/sw/conda1/manage/bin/psconda.sh; echo "PATH: $PATH"; echo "CONDA_DEFAULT_ENV: $CONDA_DEFAULT_ENV"; '
