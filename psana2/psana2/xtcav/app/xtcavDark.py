...
from psana2.pyalgos.generic.logger import init_logger, STR_LEVEL_NAMES

scrname = sys.argv[0].rsplit('/')[-1]
usage = 'E.g.: %s amox23616 104' % scrname\
      + '\n  or: %s amox23616 104 -l DEBUG -f fname.xtc2' % scrname
print(usage)
...
parser.add_argument('run_number',           type=int, help="run number") # 104
...
from psana2.xtcav.DarkBackgroundReference import DarkBackgroundReference
