...
Usage::
    ...
    #from psana2.peakFinder.pypsalg import peaks_adaptive, peaks_droplet
...
import psana2.peakFinder.pypsalg as algos
...
import psana2.peakFinder.pypsalg as algos
    ...
    from psana2.peakFinder.pypsalg import peaks_adaptive, peaks_droplet, peaks_adaptive_2d, peaks_droplet_2d
...
def numpy_2d_arr_of_peak_parameters(peaks) :
    ...
    """
    return np.array(list_of_peak_parameters(peaks), dtype=np.float32)
