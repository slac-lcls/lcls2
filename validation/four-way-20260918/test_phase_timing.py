...
@pytest.mark.parametrize('variant,kind', [('A', 'detector'), ('B', 'detector'), ('B', 'parse'), ('O', 'detector'), ('O', 'parse'), ('G', 'detector'), ('G', 'parse')])
def test_historical_transform_preserves_statements(variant, kind):
    root = Path(__file__).parent / 'installs' / variant / 'lib/python3.9/site-packages/psana/gpu'
