...
procmgr_config = [
 {                                     id:'xpmpva' ,     flags:'s',   env:epics_env,               cmd:'xpmpva DAQ:NEH:XPM:7 DAQ:FEH:XPM:8'}, # XPM8 - LCLS1 Timing
 {                                     id:'groupca',     flags:'s',   env:epics_env,               cmd:'groupca DAQ:FEH 8 '+groups},
 {                                     id:'daqstat',                                               cmd:'daqstat -i 5'},

 { host: collect_host,                 id:'control',     flags:'spu', env:epics_env,               cmd:f'control -P {hutch}:{station} -B DAQ:FEH -x 8 -C BEAM {auth} {url} -d {cdb}/configDB -t trigger -S 1 -T 20000 -V {elog_cfg}'},
 ...
 { host: 'drp-srcf-cmp014', cores: 10, id:'timing_1',    flags:'spu', env:epics_env,               cmd:drp_cmd0+' -l 0x1 -D ts'},
]
