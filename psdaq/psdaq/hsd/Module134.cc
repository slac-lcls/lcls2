...
namespace Pds {
  namespace HSD {
    ...
    public:
      ...
      uint32_t    rsvd_810000[(0x010000-sizeof(chip))>>2];
      Fmc134Ctrl  fmc_ctrl            ; // 0x810000
      uint32_t    rsvd_820000[(0x010000-sizeof(fmc_ctrl))>>2];
      Mmcm        mmcm                ; // 0x820000
      uint32_t    rsvd_840000[(0x020000-sizeof(mmcm))>>2];
      Mmhw::Reg   opt_fmc   [0x010000>>2]; // 0x840000
      Mmhw::Reg   qsfp0_i2c [0x010000>>2]; // 0x850000
      Mmhw::Reg   qsfp1_i2c [0x010000>>2]; // 0x860000
      Mmhw::Reg   surf_jesd0[0x010000>>2]; // 0x870000
      Mmhw::Reg   surf_jesd1[0x010000>>2]; // 0x880000
      TriggerEventManager2 tem          ; // 0x890000
      uint32_t    rsvd_900000[(0x070000-sizeof(tem))>>2];
      Mmhw::Reg   pgp_reg   [0x80000>>2]; // 0x900000
    };
  };
};
