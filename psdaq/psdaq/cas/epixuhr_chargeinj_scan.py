...
def main():
    ...
    args = scan.args
    args.events = np.abs((args.pulserStart-args.pulserStop)/args.pulserStep) 
    ...
    gains_dict['AHLG1Ioff'] = 16
    gains_dict['AHLG1Ion']  = 20
    gains_dict['AHLG2Ioff'] = 48
    gains_dict['AHLG2Ion']  = 52
    gains_dict['AMLG1Ioff'] = 24
    gains_dict['AMLG1Ion']  = 28
    gains_dict['AMLG2Ioff'] = 56
    gains_dict['AMLG2Ion']  = 60    
