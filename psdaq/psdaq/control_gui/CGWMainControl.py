...
from psdaq.control_gui.CGDaqControl import daq_control_set_state, daq_control_set_record, DaqControl, DaqDefs
...
class CGWMainControl(QGroupBox):
    ...
    def __init__(self, parent=None):
        ...
        self.states = ['Select',] + [s.upper() for s in DaqDefs.states]
