...
def write_to_daq_config_db(args):
    ...
    # timing system
    top.set('expert.TimeToolKcu1500.Kcu1500Hsio.TimingRx.TriggerEventManager.TriggerEventBuffer.PauseThreshold',16,'UINT32')
    top.set('expert.TimeToolKcu1500.Kcu1500Hsio.TimingRx.TriggerEventManager.TriggerEventBuffer.TriggerDelay',42,'UINT32')
    top.set('expert.TimeToolKcu1500.Kcu1500Hsio.TimingRx.TriggerEventManager.TriggerEventBuffer.Partition',0,'UINT32')

    # prescaling
    top.set("expert.TimeToolKcu1500.Application.AppLane.Prescale.DialInPreScaling",2,'UINT32')                            # prescaled raw data
    top.set("expert.TimeToolKcu1500.Application.AppLane.Fex.background_prescaler.DialInPreScaling",3,'UINT32')            # prescaled raw backgrounds (may consider accumulated backgrounds instead)

    # initial fir filter
    top.set("expert.TimeToolKcu1500.Application.AppLane.Fex.FIR.CoefficientSet0","7f7f7f7f",'CHARSTR')                      #high part of step
    top.set("expert.TimeToolKcu1500.Application.AppLane.Fex.FIR.CoefficientSet1","7f7f7f7f",'CHARSTR')                      #high part of step
    top.set("expert.TimeToolKcu1500.Application.AppLane.Fex.FIR.CoefficientSet2","7f7f7f7f",'CHARSTR')                      #high part of step
    top.set("expert.TimeToolKcu1500.Application.AppLane.Fex.FIR.CoefficientSet3","7f7f7f7f",'CHARSTR')                      #high part of step
    top.set("expert.TimeToolKcu1500.Application.AppLane.Fex.FIR.CoefficientSet4","81818181",'CHARSTR')                      #low  part of step
    top.set("expert.TimeToolKcu1500.Application.AppLane.Fex.FIR.CoefficientSet5","81818181",'CHARSTR')                      #low  part of step
    top.set("expert.TimeToolKcu1500.Application.AppLane.Fex.FIR.CoefficientSet6","81818181",'CHARSTR')                      #low  part of step
    top.set("expert.TimeToolKcu1500.Application.AppLane.Fex.FIR.CoefficientSet7","81818181",'CHARSTR')                      #low  part of step

    top.set("expert.TimeToolKcu1500.Application.AppLane.Fex.FIR.LoadCoefficients","1",'CHARSTR')                            #low  part of step.  Having a value of 1  causes a segfault in pgpread_timetool.cc.  But not in tt_config.py.

    # time constants
    top.set("expert.TimeToolKcu1500.Application.AppLane.Fex.FrameIIR.TimeConstant",8,'UINT32')

    # subtraction enabled
    top.set("expert.TimeToolKcu1500.Application.AppLane.Fex.FrameSubtractor.SubtractionActive",0,'UINT32')                   #turn background subtract on
    ...
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.LinkMode"    ,      3,'UINT32')   # Full mode
    ...
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.TapCount"    ,      8,'UINT32')   # 
    ...
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.CLS",0,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.CLM",2,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.DST",0,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.FFM",0,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.FRS",2,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.LPC",0,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.ROI[0]",1,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.ROI[1]",2048,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.SAC",1,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.SAD[0]",1,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.SAD[1]",1,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.SAD[2]",2048,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.SAM",0,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.SBH",1,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.SBR",9600,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.SBV",1,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.SCD",0,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.SEM",1,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.SET",5000,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.SMM",0,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.SPF",0,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.SSB",0,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.SSF",2,'UINT32')
    #top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.SSG",1,'UINT32') # requires two arguments (selector,gain)
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.STG",2,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.STM",1,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.SVM",0,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.USD",1,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.USL",1,'UINT32')
    top.set("expert.ClinkFeb.ClinkTop.ClinkCh.UartPiranha4.USS",1,'UINT32')

    #the object hierarchy paths (e.g. cl.TimeToolKcu1500.Application.AppLane... yadayadayada) for a device can be found by implementing
