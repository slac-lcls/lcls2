...
#    logging.getLogger().setLevel(40-10*verbosity) # way too much from rogue
    ...
    cbase.App.Adcs.PCBSlowADC.enableADC.set(1)
...
def config_expert(base, cfg, writeCalibRegs=True, secondPass=False):
    ...
    if app is not None and not secondPass:
        ...
        # Load config that sets power supply
        print("Loading supply configuration")
        cbase.root.LoadConfig(cbase.filenamePowerSupply)
        print("Loaded {}".format(cbase.filenamePowerSupply))
