...
#define EpochList LinkedList<EbEpoch>   // Notational convenience...
    ...
    class EventBuilder : protected Pds::Timer
    {
    public:
    ...
    public:
      ...
      virtual uint64_t   contract(EbContribution*)       = 0;
    ...
    public:
      void               process(Datagram*, void* context);
    private:
      ...
      void              _fixup(EbEvent*);
      EbEvent*          _event(EbContribution*, EbEvent* after, void* context);
      void              _flush(EbEvent*);
      void              _retire(EbEvent*);
      EbEvent*          _insert(EbEpoch*, EbContribution*, void* context);
      EbEvent*          _insert(EbContribution*, void* context);
    private:
