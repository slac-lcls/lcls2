#ifndef RINGQUEUE_DTOD_HH
#define RINGQUEUE_DTOD_HH
...
{
public:
  __host__ RingQueueDtoD(const unsigned capacity) :
    m_head        (nullptr),
    m_tail        (nullptr),
  ...
  __device__ bool push(const T& value) const           /** Store value at head and advance when not full */
  {
