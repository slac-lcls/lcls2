...
**Status:** Historical measurements from August 2026, using commit
`e18cf6bb700152c461c2884bbfa28014d8d6e006`. This is the source report
corresponding to the supplied “GPU performance summary — Jungfrau, single S3DF
node” PDF. Relocated from `notes/psana2_gpu_performance_20260830.md`; the
measurements and reproduction commands below describe that historical runtime,
not the current bulk-read implementation.
