...
def cy_calib_jungfrau_v4_empty():
    return calib_jungfrau_v4_empty() # returns double time, us


def cy_calib_jungfrau_v5_empty(cnp.ndarray[rawd_t, ndim=1] raw,
                 cnp.ndarray[cc_t, ndim=1] cc,
		 sizeb_t size,
		 sizeb_t size_blk,
		 cnp.ndarray[out_t, ndim=1] out):
