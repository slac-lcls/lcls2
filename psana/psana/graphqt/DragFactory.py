...
def add_item(type, obj, parent=None, scene=None,\
    ...
    elif type == CIRC  : return DragPoint(obj, parent, scene, brush_w, pen, pshape='z', rsize=11)
    elif type == WEDG  : return DragPoint(obj, parent, scene, brush_w, pen, pshape='w', rsize=8)
    elif type == POLY  : return DragPoint(obj, parent, scene, brush_w, pen, pshape='x', rsize=11)
