...
"""Class :py:class:`CMWDBButtonsWeb` is a QWidget for configuration parameters
==============================================================================

Usage ::
    # Test: python lcls2/psana/psana/graphqt/CMWDBButtonsWeb.py
...
2021-05-13 copied from CMWDBButtonsWeb, use web-sevice interface from CMDBUtilsWeb in stead of CMDBUtils
"""
...
dbu = None
import psana.graphqt.CMDBUtilsWeb as wu


class CMWDBButtonsWeb(QWidget):
    """QWidget for managements of configuration parameters"""

    def __init__(self, parent=None):
        QWidget.__init__(self, parent)
        self._name = 'CMWDBButtonsWeb'
...
#        #cp.posGUIMain = (self.pos().x(),self.pos().y())
    ...
    def closeEvent(self, event):
        ...
        #try   : del cp.guiworkresdirs # CMWDBButtonsWeb
