...
class GWViewImageROI(GWViewImAx):
    ...
    def __init__(self, parent=None, arr=None,\
        ...
        GWViewImAx.__init__(self, parent, arr, coltab, origin, scale_ctl, show_mode, signal_fast)
    ...
    def mousePressEvent(self, e):
        GWViewImAx.mousePressEvent(self, e)
    ...
    def mouseMoveEvent(self, e):
        ...
        GWViewImAx.mouseMoveEvent(self, e)
        if   self.mode_type < roiu.ADD: return
    ...
    def mouseReleaseEvent(self, e):
        GWViewImAx.mouseReleaseEvent(self, e)
    ...
    def set_pixmap_from_arr(self, arr, set_def=True, amin=None, amax=None, frmin=0.00001, frmax=0.99999):
        ...
        GWViewImAx.set_pixmap_from_arr(self, arr, set_def, amin, amax, frmin, frmax)
