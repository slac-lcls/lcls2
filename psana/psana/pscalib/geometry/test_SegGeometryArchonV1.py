...
from psana.pscalib.geometry.SegGeometryArchonV1 import *
...
if __name__ == "__main__":
  ...
  def test_xyz_min_max():
    w = SegGeometryArchonV1(detector=detector_simulator(shape=(300,4800)))
    w.print_seg_info()
  ...
  def test_xyz_maps():
    w = SegGeometryArchonV1(detector=detector_simulator(shape=(150,4800)))
    #w.print_seg_info()
    titles = ['X map','Y map']
  ...
  def test_archon_img():
    ...
    #w = SegGeometryArchonV1(use_wide_pix_center=True)
