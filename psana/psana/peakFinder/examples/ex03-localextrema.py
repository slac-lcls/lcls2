#!/usr/bin/env python
""" test of psalg_ext.local_minimums, local_maximums, local_maximums_rank1_cross, threshold_maximums
"""
#----------
import sys
...
def test01(tname='1', NUMBER_OF_EVENTS=5, DO_PRINT=False) :
    ...
    for evnum in range(NUMBER_OF_EVENTS) :
        ...
        #gr.plot_imgcb(fig1, axim1, axcb1, imsh1, img1, amin=amin, amax=amax, title='Event: %d, Data'%evnum, cmap='inferno')
        ...
        gr.imshow_cbar(fig2, axim2, axcb2, img2, amin=0, amax=5, extent=None,\
                       interpolation='nearest', aspect='auto', origin='upper',\
                       orientation='vertical', cmap='inferno')
        #gr.plot_imgcb(fig2, axim2, axcb2, imsh2, img2, amin=0, amax=5, title='Event: %d, Local extrema'%evnum, cmap='inferno')
