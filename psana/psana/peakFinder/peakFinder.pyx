...
cdef extern from "psalg/peaks/PeakFinderAlgos.hh" namespace "psalgos":
    cdef cppclass Peak :
        Peak() except +
...
cdef extern from "psalg/peaks/Types.hh" namespace "types":
...
cdef extern from "psalg/peaks/LocalExtrema.hh" namespace "localextrema":
