...
cdef extern from "peakFinder/include/PeakFinderAlgos.hh" namespace "psalgos":
    cdef cppclass Peak :
        Peak() except +
...
cdef extern from "peakFinder/include/Types.hh" namespace "types":
...
cdef extern from "peakFinder/include/LocalExtrema.hh" namespace "localextrema":
