...
cdef extern from "psana/peakFinder/include/PeakFinderAlgos.hh" namespace "psalgos":
    cdef cppclass Peak :
        Peak() except +
...
cdef extern from "psana/peakFinder/include/Types.hh" namespace "types":
...
cdef extern from "psana/peakFinder/include/LocalExtrema.hh" namespace "localextrema":
