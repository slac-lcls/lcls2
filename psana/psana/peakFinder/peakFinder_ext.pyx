...
cdef extern from "psana/peakFinder/PeakFinderAlgos.hh" namespace "psalgos":
    cdef cppclass Peak :
        Peak() except +
...
cdef extern from "psana/peakFinder/Types.hh" namespace "types":
...
cdef extern from "psana/peakFinder/LocalExtrema.hh" namespace "localextrema":
