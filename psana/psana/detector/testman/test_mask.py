...
def test_umask(det):
    ...
    mask = np.ones_like(mstatus, dtype=np.int8)
...
def test_mask_select(tname, det):
    ...
    if tname == '9':
        ...
        status = det.raw._mask_from_status()
...
if TNAME in ( '1', '2', '3', '4', '5', '6', '7', '9',\
             '11','12','13','14','15','16',\
             '21','22','23','24','25','26'): test_mask(TNAME)
else:
    print(USAGE)
