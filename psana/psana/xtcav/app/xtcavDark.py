...
usage = 'E.g.: %s amox23616 104' % sys.argv[0].rsplit('/')[-1]\
      + '  or: %s -f /reg/g/psdm/detector/data2_test/xtc/data-amox23616-r0104-e000400-xtcav-v2.xtc2 amox23616 104' % sys.argv[0].rsplit('/')[-1]
print(usage)
...
parser.add_argument('-f', '--fname', type=str, default='/reg/g/psdm/detector/data2_test/xtc/data-amox23616-r0104-e000400-xtcav-v2.xtc2', help='xtc2 file')
