...
def bin_indexes(o, vals, edgemode=0, cmt=''):
...
def test_HBins():
    ...
    o1 = HBins((1,6), 5);     hbins(o1, 'Test HBins for EQUAL BINS')
    o2 = HBins((1, 2, 4, 8)); hbins(o2, 'Test HBins for VARIABLE BINS')
    ...
    bin_indexes(o1, vals, edgemode=0, cmt='Test for EQUAL BINS')
    bin_indexes(o1, vals, edgemode=1, cmt='Test for EQUAL BINS')
    bin_indexes(o2, vals, edgemode=0, cmt='Test for VARIABLE BINS')
    bin_indexes(o2, vals, edgemode=1, cmt='Test for VARIABLE BINS')

    bin_data(o1, cmt='Test set_bin_data and bin_data methods')
