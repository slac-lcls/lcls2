...
char TEST_CONFIG_FILE[]  = "/reg/g/psdm/detector/data_test/lmf/sorter.txt";

///////////////////////////////////////////////
int main(int argc, char* argv[], char* envp[])
///////////////////////////////////////////////
{
	printf("syntax: ex04_sort [filename]\n");
	printf("        This file will be sorted and a new file will be written.\n\n");

	if (argc < 2)	{
		printf("Default filename is used...\n");
	}
	if (argc > 2)	{
	...
	if (!read_config_file(TEST_CONFIG_FILE, sorter, command, 
