...
if [[ $OS == linux ]]; then
  ...
  python -u -c "while 1: import requests; print('*** requesting'); requests.get('https://pswww.slac.stanford.edu/calib_ws/cdb_ueddaq02/gridfs/6035d64545db0b188f7c78e8',None); print('*** done fetch')"
