...
const gsize_t SegGeometryCspad2x1V1::ROWS; //     = 185;
const gsize_t SegGeometryCspad2x1V1::COLS; //     = 388;
const gsize_t SegGeometryCspad2x1V1::COLSHALF; // = 194;
const gsize_t SegGeometryCspad2x1V1::SIZE; //     = COLS*ROWS; 
const gsize_t SegGeometryCspad2x1V1::NCORNERS; //    =   4;

const pixel_coord_t SegGeometryCspad2x1V1::PIX_SCALE_SIZE = 109.92;
const pixel_coord_t SegGeometryCspad2x1V1::PIX_SIZE_COLS  = PIX_SCALE_SIZE;
const pixel_coord_t SegGeometryCspad2x1V1::PIX_SIZE_ROWS  = PIX_SCALE_SIZE;
const pixel_coord_t SegGeometryCspad2x1V1::PIX_SIZE_WIDE  = 274.80;
const pixel_coord_t SegGeometryCspad2x1V1::PIX_SIZE_DEPTH = 400.;
const double        SegGeometryCspad2x1V1::UM_TO_PIX      = 1./PIX_SCALE_SIZE;

const gsize_t SegGeometryCspad2x1V1::IND_CORNER[NCORNERS] = {0, COLS-1, (ROWS-1)*COLS, ROWS*COLS-1};
const gsize_t SegGeometryCspad2x1V1::ARR_SHAPE[2] = {ROWS, COLS};
...
void SegGeometryCspad2x1V1::make_pixel_coord_arrs()
{
  ...
  pixel_coord_t y_offset = (ROWS-1) * PIX_SIZE_ROWS / 2;
  for(gsize_t r=0; r<ROWS; r++) m_y_arr_um[r] = y_offset - r * PIX_SIZE_ROWS;
...
const pixel_area_t* SegGeometryCspad2x1V1::pixel_area_array()
{
...
const pixel_coord_t* SegGeometryCspad2x1V1::pixel_size_array(AXIS axis)
{
  make_pixel_size_arrs();
...
const pixel_coord_t* SegGeometryCspad2x1V1::pixel_coord_array(AXIS axis) 
{ 
...
const pixel_coord_t SegGeometryCspad2x1V1::pixel_coord_min(AXIS axis) 
{ 
...
const pixel_coord_t SegGeometryCspad2x1V1::pixel_coord_max(AXIS axis) 
{ 
  const pixel_coord_t* arr = pixel_coord_array (axis);
  pixel_coord_t corner_coords[NCORNERS];
  for(gsize_t i=0; i<NCORNERS; ++i) {corner_coords[i] = arr[IND_CORNER[i]];}
