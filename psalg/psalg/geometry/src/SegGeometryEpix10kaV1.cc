...
const gsize_t SegGeometryEpix10kaV1::ROWS; //     = 352;
const gsize_t SegGeometryEpix10kaV1::COLS; //     = 384;
const gsize_t SegGeometryEpix10kaV1::ROWSHALF; // = 352/2;
const gsize_t SegGeometryEpix10kaV1::COLSHALF; // = 384/2;
const gsize_t SegGeometryEpix10kaV1::SIZE; //     = COLS*ROWS; 
const gsize_t SegGeometryEpix10kaV1::NCORNERS; //    =   4;

const pixel_coord_t SegGeometryEpix10kaV1::PIX_SCALE_SIZE = 100.00;
const pixel_coord_t SegGeometryEpix10kaV1::PIX_SIZE_COLS  = PIX_SCALE_SIZE;
const pixel_coord_t SegGeometryEpix10kaV1::PIX_SIZE_ROWS  = PIX_SCALE_SIZE;
const pixel_coord_t SegGeometryEpix10kaV1::PIX_SIZE_WIDE  = 250.00;
const pixel_coord_t SegGeometryEpix10kaV1::PIX_SIZE_DEPTH = 400.;
const double        SegGeometryEpix10kaV1::UM_TO_PIX      = 1./PIX_SCALE_SIZE;

const gsize_t SegGeometryEpix10kaV1::IND_CORNER[NCORNERS] = {0, COLS-1, (ROWS-1)*COLS, ROWS*COLS-1};
const gsize_t SegGeometryEpix10kaV1::ARR_SHAPE[2] = {ROWS, COLS};
...
void SegGeometryEpix10kaV1::print_seg_info(const bitword_t& pbits)
{
...
const pixel_area_t* SegGeometryEpix10kaV1::pixel_area_array()
{
...
const pixel_coord_t* SegGeometryEpix10kaV1::pixel_size_array(AXIS axis)
{
  make_pixel_size_arrs();
...
const pixel_coord_t* SegGeometryEpix10kaV1::pixel_coord_array (AXIS axis) 
{ 
...
const pixel_coord_t SegGeometryEpix10kaV1::pixel_coord_min (AXIS axis) 
{ 
...
const pixel_coord_t SegGeometryEpix10kaV1::pixel_coord_max (AXIS axis) 
{ 
  const pixel_coord_t* arr = pixel_coord_array (axis);
  pixel_coord_t corner_coords[NCORNERS];
  for(gsize_t i=0; i<NCORNERS; ++i) {corner_coords[i] = arr[IND_CORNER[i]];}
...
const pixel_mask_t* SegGeometryEpix10kaV1::pixel_mask_array(const bitword_t& mbits)
{
