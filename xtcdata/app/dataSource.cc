...
static void
dataSource_dealloc(dataSource* self)
{
...
static int
dataSource_init(dataSource *self, PyObject *args, PyObject *kwds)
{
...
static PyObject*
dataSource_nextDgram(dataSource *self){
