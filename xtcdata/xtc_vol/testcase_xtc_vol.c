...
//        xtc_vol_info.my_rank = my_rank;
    ...
    printf("HDF5 XTC VOL test done. attr_test took %lu usec,  avg = %lu\n", t, (t / num_ops));

    t= dset_extend_test(benchmark_type, file_name, fapl);
    printf("HDF5 XTC VOL test done. dset_extend_test took %lu usec,  avg = %lu\n", t, t);

    t = dt_commit_test(benchmark_type, file_name, fapl, num_ops);
    printf("HDF5 XTC VOL test done. dt_commit_test took %lu usec,  avg = %lu\n", t, (t / num_ops));
    //=================================================================
    H5Pclose(fapl);
