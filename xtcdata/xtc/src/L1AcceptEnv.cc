...
uint32_t Pds::L1AcceptEnv::clientGroupMask() const
{
    return value() & ((1 << MaxReadoutGroups) - 1);
}

Pds::L1AcceptEnv::L3TResult Pds::L1AcceptEnv::l3t_result() const
{
    return L3TResult((value() >> MaxReadoutGroups) & 3);
}

bool Pds::L1AcceptEnv::trimmed() const
{
    return value() & TrimValue;
}

bool Pds::L1AcceptEnv::unbiased() const
{
